...
if [[ $STATUS == "paused" ]]; then
  ...
  dunstify "Song Volume: " -i ~/.config/dunst/images/song_volume2.png -u normal -t 1000 -h int:value:"`mpc volume | awk '{ print $2 }'`" -h string:synchronous:"Volume: " --replace=555
fi
